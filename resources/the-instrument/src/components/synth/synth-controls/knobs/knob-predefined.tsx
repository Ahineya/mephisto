...
import {createConversionFunctions} from "../../../../../helpers/linear-conversion";
...
export const KnobPredefined = ({
  ...
  return <div className={classNames("knob", {active: isMoving})}>
    <div className={classNames("knob-circle-container", {active: isMoving, [`knob-size-${size || 'medium'}`]: true})}
